...
- **Dependency Inversion Principle (DIP):**  
  High-level modules depend on abstractions (interfaces) rather than concrete classes.
  
- **Dependency Injection (DI):**  
  Interfaces and dependencies are injected at runtime for loose coupling and easier testing.
